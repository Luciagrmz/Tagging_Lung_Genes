...
# python3.4 training-validation-v1.py --inputPath /export/space1/users/luciarn/BEII/Bionlp/conditional-random-fields/data-sets --trainingFile training-data-set-70.txt --testFile test-data-set-30.txt --outputPath /export/space1/users/luciarn/BEII/Bionlp/conditional-random-fields > output-training.txt
...
if __name__ == "__main__":
    ...
    nameReport = options.trainingFile.replace('.txt', '.fStopWords_' + str(options.excludeStopWords) + '.fSymbols_' + str(
        options.excludeSymbols) + '_v1.txt')
    ...
    nameModel = options.trainingFile.replace('.txt', '.fStopWords_' + str(options.excludeStopWords) + '.fSymbols_' + str(
        options.excludeSymbols) + '_v1.mod')
